...
kaede_attack_4,
kaede_hajiki_2,
kaede_kyusei_sitotu_1,
kaede_kyusei_sitotu_2,
Repel,
Tackle,
kaede_ha_attack_01,
kaede_ha_attack_02,
    ...
    public static Dictionary<AudioName, string> audionames = new Dictionary<AudioName, string> 
{
    ...
    {AudioName.kaede_attack_1,"kaede_attack_1"},
    {AudioName.kaede_attack_2,"kaede_attack_2"},
    {AudioName.kaede_attack_3,"kaede_attack_3"},
    {AudioName.kaede_attack_4,"kaede_attack_4"},
    {AudioName.kaede_hajiki_2,"kaede_hajiki_2"},
    {AudioName.kaede_kyusei_sitotu_1,"kaede_kyusei_sitotu_1"},
    {AudioName.kaede_kyusei_sitotu_2,"kaede_kyusei_sitotu_2"},
