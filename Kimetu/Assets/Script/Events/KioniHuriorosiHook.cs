...
public class KioniHuriorosiHook : MonoBehaviour, IEventHook {
	...
	public void KioniHuriorosiStart() {
		Debug.Log("KioniHuriorosiStart");
		this.animationNow = true;
		subject.OnNext(true);
	}

	public void KioniHuriorosiEnd() {
		Debug.Log("KioniHuriorosiEnd");
