...
public class SetunaGreat_swordHook : MonoBehaviour, IEventHook {
	...
	public void SetunaGreat_swordStart() {
		Debug.Log("SetunaGreat_swordStart");
		this.animationNow = true;
		subject.OnNext(true);
	}

	public void SetunaGreat_swordEnd() {
		Debug.Log("SetunaGreat_swordEnd");
