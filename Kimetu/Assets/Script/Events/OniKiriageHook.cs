...
public class OniKiriageHook : MonoBehaviour, IEventHook {
	...
	public void OniKiriageStart() {
		Debug.Log("OniKiriageStart");
		this.animationNow = true;
		subject.OnNext(true);
	}

	public void OniKiriageEnd() {
		Debug.Log("OniKiriageEnd");
