...
public class SetunaStand_torchHook : MonoBehaviour, IEventHook {
	...
	public void SetunaStand_torchStart() {
		Debug.Log("SetunaStand_torchStart");
		this.animationNow = true;
		subject.OnNext(true);
	}

	public void SetunaStand_torchEnd() {
		Debug.Log("SetunaStand_torchEnd");
