...
public class SetunaDownHook : MonoBehaviour, IEventHook {
	...
	public void SetunaDownStart() {
		Debug.Log("SetunaDownStart");
		this.animationNow = true;
		subject.OnNext(true);
	}

	public void SetunaDownEnd() {
		Debug.Log("SetunaDownEnd");
