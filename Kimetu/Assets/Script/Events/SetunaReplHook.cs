...
public class SetunaReplHook : MonoBehaviour, IEventHook {
	...
	public void SetunaReplStart() {
		Debug.Log("SetunaReplStart");
		this.animationNow = true;
		subject.OnNext(true);
	}

	public void SetunaReplEnd() {
		Debug.Log("SetunaReplEnd");
